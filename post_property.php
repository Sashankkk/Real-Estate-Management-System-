   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="number" name="deposit" required min="0" max="9999999999" maxlength="10" placeholder="deposit Amount" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="sq fts" class="input">
         </div>
         <div class="box">
